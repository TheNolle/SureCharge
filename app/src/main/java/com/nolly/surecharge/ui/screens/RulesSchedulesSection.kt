...
internal enum class Weekday(val label: String, val bitIndex: Int) {
	Sunday("Sun", 0),
	Monday("Mon", 1),
	Tuesday("Tue", 2),
	Wednesday("Wed", 3),
...
internal fun allDaysMask(): Int = (1 shl 7) - 1

internal fun weekdaysMask(): Int =
...
internal fun weekendMask(): Int =
	(1 shl Weekday.Sunday.bitIndex) or
			(1 shl Weekday.Saturday.bitIndex)

internal fun toggleDay(mask: Int, day: Weekday): Int {
...
internal fun isDaySelected(mask: Int, day: Weekday): Boolean {
	val bit = 1 shl day.bitIndex
	return (mask and bit) != 0
}

internal fun daysMaskLabel(mask: Int): String {
	return when (mask) {
...
internal fun minutesToTimeString(minutes: Int): String {
...
internal fun createDefaultSchedule(): Schedule {
	return Schedule(
		id = 0,
		name = "",
		enabled = true,
